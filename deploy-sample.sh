...
docker compose -f ${remote_path_app}/compose/compose-dev.yml down || true
docker compose -f ${remote_path_app}/compose/compose-dev.yml --env-file ${remote_path_app}/compose/config/.env up -d --build
exit
EOF
